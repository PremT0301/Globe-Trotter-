    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 left-10 w-40 h-40 bg-gradient-to-r from-blue-400/30 to-indigo-400/30 rounded-full"
        />
        <motion.div
          animate={{
            x: [0, -120, 80, 0],
          ...
          className="absolute top-40 right-20 w-32 h-32 bg-gradient-to-r from-purple-400/30 to-pink-400/30 rounded-full"
        />
        <motion.div
          animate={{
            x: [0, 80, -60, 0],
          ...
          className="absolute bottom-20 left-1/4 w-36 h-36 bg-gradient-to-r from-indigo-400/30 to-blue-400/30 rounded-full"
        />
        <motion.div
          animate={{
            x: [0, -60, 70, 0],
          ...
          className="absolute bottom-40 right-1/3 w-28 h-28 bg-gradient-to-r from-cyan-400/30 to-blue-400/30 rounded-full"
        />
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-24 h-24 border-2 border-blue-300/30 rounded-lg"
        />
        <motion.div
          animate={{
            rotate: [360, 0, -360],
          ...
          className="absolute bottom-1/4 right-1/4 w-20 h-20 border-2 border-purple-300/30 rounded-full"
        />
